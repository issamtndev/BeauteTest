 ...
 */
class Categories extends \MyAppBundle\Entity\Categories implements \Doctrine\ORM\Proxy\Proxy
{
    /**
    ...
    public function __sleep()
    {
        if ($this->__isInitialized__) {
            return array('__isInitialized__', '' . "\0" . 'MyAppBundle\\Entity\\Categories' . "\0" . 'id', '' . "\0" . 'MyAppBundle\\Entity\\Categories' . "\0" . 'name', '' . "\0" . 'MyAppBundle\\Entity\\Categories' . "\0" . 'parentId', '' . "\0" . 'MyAppBundle\\Entity\\Categories' . "\0" . 'url', '' . "\0" . 'MyAppBundle\\Entity\\Categories' . "\0" . 'products');
        }
