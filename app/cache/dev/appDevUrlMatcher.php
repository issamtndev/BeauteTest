...
class appDevUrlMatcher extends Symfony\Bundle\FrameworkBundle\Routing\RedirectableUrlMatcher
{
    ...
    public function match($pathinfo)
    {
        ...
        if (rtrim($pathinfo, '/') === '') {
            if (substr($pathinfo, -1) !== '/') {
                return $this->redirect($pathinfo.'/', 'my_app_homepage');
            }

            return array (  '_controller' => 'MyAppBundle\\Controller\\DefaultController::indexAction',  '_route' => 'my_app_homepage',);
        }

        // my_app_sous_categ
        if ($pathinfo === '/sous_categories') {
            return array (  '_controller' => 'MyAppBundle\\Controller\\DefaultController::sous_categoriesAction',  '_route' => 'my_app_sous_categ',);
        }
        ...
        if (0 === strpos($pathinfo, '/recherche')) {
            ...
            // my_app_recherche_marque
            if ($pathinfo === '/recherchemarque') {
                return array (  '_controller' => 'MyAppBundle\\Controller\\DefaultController::recherche_marqueAction',  '_route' => 'my_app_recherche_marque',);
            }

        }

        // my_app_recherche_all_marque
        if ($pathinfo === '/allmarque') {
            return array (  '_controller' => 'MyAppBundle\\Controller\\DefaultController::all_marqueAction',  '_route' => 'my_app_recherche_all_marque',);
        }

        // my_app_recherche_avis
        if ($pathinfo === '/rechercheavis') {
